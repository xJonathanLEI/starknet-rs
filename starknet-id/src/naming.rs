...
use starknet_core::types::{BlockId, CallFunction, FieldElement};
...
const SELECTOR_D2A: FieldElement = FieldElement::from_mont([
    6985039847805449502,
    5414334324946440161,
...
const SELECTOR_A2D: FieldElement = FieldElement::from_mont([
