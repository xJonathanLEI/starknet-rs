...
sed -i "s/indent=4/separators=(',', ':')/g" /src/cairo-lang/src/starkware/cairo/lang/compiler/cairo_compile.py

# Ugly hack to send the internal hinted class hash to stdout
sed -i "s/return structs\\.DeprecatedCompiledClass/print(f\\\"  \\\\\\\"hinted_class_hash\\\\\\\": \\\\\\\"{hex(compute_deprecated_hinted_class_hash(contract_class=contract_class))}\\\\\\\",\")\\n    return structs\\.DeprecatedCompiledClass/g" /src/cairo-lang/src/starkware/starknet/core/os/contract_class/deprecated_class_hash.py
